    ...
    return (
        <Container>
            ...
            <Typography variant="body1" paragraph style={{ fontStyle: 'italic' }}>
                <a href="https://api.peerfeedback.betbet.website/login" target="_blank" rel="noopener noreferrer">
                    https://api.peerfeedback.betbet.website/login
                </a>
            </Typography>
            <Typography variant="body1" paragraph>
            ...
            <Typography variant="body1" paragraph style={{ fontStyle: 'italic' }}>
                <a href="https://api.peerfeedback.betbet.website/profile" target="_blank" rel="noopener noreferrer">
                    https://api.peerfeedback.betbet.website/profile
                </a>
            </Typography>
            <Typography variant="body1" paragraph>
