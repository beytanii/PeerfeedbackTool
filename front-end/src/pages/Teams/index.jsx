  ...
  useEffect(() => {
    ...
    const fetchTeamName = async () => {
      try {
        ...
        const response = await fetch(`https://api.peerfeedback.betbet.website/teams/teamName?groupID=${storedGroupID}&teamID=${teamID}`);
    ...
    const fetchUsersData = async () => {
      try {
        const response = await fetch(`https://api.peerfeedback.betbet.website/teams/users?teamID=${teamID}`);
        const data = await response.json();
