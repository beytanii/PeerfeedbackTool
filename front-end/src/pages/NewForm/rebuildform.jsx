...
function RebuildForm() {
  ...
  useEffect(() => {
    ...
    const getUserInfo = async (username) => {
      try {
        const response = await fetch(`http://betbet.website/users/username/${username}`);
  ...
  const markFormAsCompleted = async () => {
    try {
      const response = await fetch('http://betbet.website/forms/markFormAsCompleted', {
        method: 'POST',
        headers: {
  ...
  const fetchData = async (retry = false) => {
    ...
    try {
      ...
      const assignmentsResponse = await fetch(`http://betbet.website/answers/incomplete?formID=${formID}&reviewerID=${reviewerID}`);
  ...
  const handleSurveyCompletion = async (answers) => {
    ...
    try {
      const response = await fetch("http://betbet.website/answers/insert", {
        method: "POST",
