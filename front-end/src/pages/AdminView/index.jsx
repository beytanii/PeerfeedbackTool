...
function AdminPage() {
  ...
  const fetchAllUsers = async () => {
    setLoading(true);
    try {
      const response = await fetch('https://api.peerfeedback.betbet.website/users/all', {
        method: 'GET',
        headers: {
  ...
  const handleUpdateAccessLevel = async (userId, newAccessLevel) => {
    ...
    try {
      const response = await fetch(`https://api.peerfeedback.betbet.website/users/access-level`, {
