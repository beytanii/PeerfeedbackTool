...
function ResponsesPage() {
    ...
    const fetchUserResponses = async (userID) => {
        try {
            const response = await fetch(`http://betbet.website/answers/responses/form?formID=${selectedFormID}&userID=${userID}`);
    ...
    const fetchUserEvaluations = async (userID) => {
        try {
            const response = await fetch(`http://betbet.website/answers/getuserevaluations/?formID=${selectedFormID}&userID=${userID}`);
