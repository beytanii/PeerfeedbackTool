...
function EditGroup() {
    ...
    useEffect(() => {
        ...
        if (formID) {
            const fetchGroupID = async () => {
                try {
                    const response = await fetch(`http://betbet.website/groups/getGroupIdByFormId/${formID}`);
    ...
    useEffect(() => {
        ...
        if (groupID) {
            const fetchGroupDetails = async () => {
                try {
                    const groupNameResponse = await fetch(`http://betbet.website/groups/groupname/${groupID}`);
                    ...
                    const teamsResponse = await fetch(`http://betbet.website/teams/${groupID}`);
    ...
    const saveTeamName = async (teamID, newTeamName) => {
        try {
            const response = await fetch('http://betbet.website/teams/updateTeamName', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
